...
export const UPWARD_MOBILITY_SECTIONS = {
    ...
    SECTION_5: {
        ...
        items: [
            ...
            {
                label: 'Bilangan Terkini Pekerja Sepenuh Masa / Full-Time',
                field: 'UM_PEKERJA_SEMASA',
                placeholder: 'Cth: 2',
                ulasanLabel: 'Ulasan Mentor *',
                ulasanField: 'UM_ULASAN_PEKERJA',
                ulasanPlaceholder: 'Cth: Tambah 1 pekerja untuk bantu packaging.'
            },
            {
                label: 'Bilangan Terkini Pekerja Part-Time',
            ...
            {
                type: 'number_rm',
                label: 'Pembayaran Zakat Perniagaan Semasa (RM)',
                field: 'UM_ZAKAT_SEMASA',
                placeholder: 'Cth: 500 (masukkan 0 jika tidak bayar zakat)',
                ulasanLabel: 'Ulasan Mentor *',
                ulasanField: 'UM_ULASAN_ZAKAT',
                ulasanPlaceholder: 'Cth: Usahawan bayar zakat RM500 untuk tahun ini. (0 = tidak bayar zakat)'
            }
        ]
    },
    SECTION_6: {
...
export const validateUpwardMobility = (umState, isMIA = false) => {
    ...
    // Validate Zakat amount (must be a valid number, 0 is acceptable)
    if (umState.UM_ZAKAT_SEMASA === '' || umState.UM_ZAKAT_SEMASA === null || umState.UM_ZAKAT_SEMASA === undefined) {
        errors.push('Upward Mobility - Pembayaran Zakat Perniagaan Semasa adalah wajib diisi');
    } else if (isNaN(umState.UM_ZAKAT_SEMASA)) {
        errors.push('Upward Mobility - Pembayaran Zakat Perniagaan Semasa mesti nombor yang sah');
    }
