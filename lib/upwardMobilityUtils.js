...
export const UPWARD_MOBILITY_SECTIONS = {
    ...
    SECTION_5: {
        ...
        items: [
            ...
            },
            {
                ...
                field: 'UM_ASET_TUNAI_SEMASA',
                placeholder: 'Cth: 5000',
                ulasanLabel: 'Ulasan Mentor *',
                ulasanField: 'UM_ULASAN_ASET_TUNAI',
                ulasanPlaceholder: 'Cth: Cash flow lebih baik berbanding bulan lepas.'
            },
            {
    ...
    SECTION_6: {
        ...
        digital: {
            label: "Penggunaan Digital Semasa",
        ...
        marketing: {
            label: "Jualan & Pemasaran Online Semasa",
            field: "UM_MARKETING_SEMASA",
            options: [
                'Jualan Bisnes secara Online (e-commerce)',
                'Pemasaran secara Online and Live (Ads, Live)',
...
export const validateUpwardMobility = (umState, isMIA = false) => {
    ...
    if (!umState.UM_ULASAN_ASET_TUNAI || umState.UM_ULASAN_ASET_TUNAI.trim() === '') {
